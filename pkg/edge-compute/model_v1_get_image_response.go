...
type NullableV1GetImageResponse struct {
	value *V1GetImageResponse
	isSet bool
}

func (v NullableV1GetImageResponse) Get() *V1GetImageResponse {
	return v.value
}
...
func NewNullableV1GetImageResponse(val *V1GetImageResponse) *NullableV1GetImageResponse {
	return &NullableV1GetImageResponse{value: val, isSet: true}
}
