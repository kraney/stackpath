...
func NewV2CreateAlertConditionRequest() *V2CreateAlertConditionRequest {
	this := V2CreateAlertConditionRequest{}
...
type NullableV2CreateAlertConditionRequest struct {
	value *V2CreateAlertConditionRequest
	isSet bool
}

func (v NullableV2CreateAlertConditionRequest) Get() *V2CreateAlertConditionRequest {
	return v.value
}

func (v *NullableV2CreateAlertConditionRequest) Set(val *V2CreateAlertConditionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableV2CreateAlertConditionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableV2CreateAlertConditionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2CreateAlertConditionRequest(val *V2CreateAlertConditionRequest) *NullableV2CreateAlertConditionRequest {
	return &NullableV2CreateAlertConditionRequest{value: val, isSet: true}
}
